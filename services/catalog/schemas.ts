...
const objectFitSchema = z.enum(imageObjectFits).default(defaultImageFit);
...
const categorySchema = z
  .object({
    ...
    thumbnailObjectFit: objectFitSchema,
    thumbnailObjectPosition: objectPositionSchema,
...
const productSchema = z
  .object({
    ...
    primaryImageObjectFit: objectFitSchema,
    primaryImageObjectPosition: objectPositionSchema,

...
export function eventEnvelopeSchema<
  ...
  TProducer extends "commerce" | "inventory" | "payment" | "customer-data",
...
export const inventoryReservationChangedV1Schema = eventEnvelopeSchema(
  "inventory.reservation.changed.v1",
  "inventory",
  inventoryReservationPayloadSchema,
);
export const commerceOrderStatusChangedV1Schema = eventEnvelopeSchema(
  "commerce.order.status-changed.v1",
  "commerce",
  orderStatusPayloadSchema,
);
export const commerceOrderConfirmedV1Schema = eventEnvelopeSchema(
  "commerce.order.confirmed.v1",
  "commerce",
  orderStatusPayloadSchema.extend({ status: z.literal("confirmed") }),
);
export const paymentStatusChangedV1Schema = eventEnvelopeSchema(
